  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in-scale">
      <div className="mb-6">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-black text-white mb-3"><span>📢</span> <span className="gradient-text">전체 공지사항 발송</span></h1>
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-gray-200 mb-2">
              공지사항 내용 <span className="text-red-400">*</span>
            </label>
            <Textarea
              value={message}
          ...
          <div className="glass border border-yellow-500/30 rounded-xl p-4">
            <div className="flex gap-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-yellow-400 mb-1">주의사항</h3>
      ...
      <Card className="mt-8">
        <h2 className="text-lg font-semibold text-white mb-3">💡 사용 팁</h2>
